...
router.get("/getRecordedSubjects", routes.views.dataportal.getRecordedSubjects);
router.post("/deleteRecordedSubject", routes.views.dataportal.deleteRecordedSubject);
router.post("/updateRecordedSubjects", routes.views.dataportal.updateRecordedSubjects);
